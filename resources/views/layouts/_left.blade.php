    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active treeview">
                <a href="#">
                    <i class="fa fa-dashboard"></i> <span>商家店铺</span>
            ...
            <li class="active treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="{{route('menuCategories.index')}}"><i class="fa fa-circle-o"></i>菜品分类管理</a></li>
                    <li><a href="{{route('menuCategories.add')}}"><i class="fa fa-circle-o"></i>添加菜品分类</a></li>
                </ul>
            </li>
            <li class="active treeview">
                <a href="#">
                    <i class="fa fa-dashboard"></i> <span>商家菜品管理</span>
                    <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
                <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="{{route('menu.add')}}"><i class="fa fa-circle-o"></i>菜品添加</a></li>
